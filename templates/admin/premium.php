    ...
    <div class="section section-cta section-odd">
        <div class="landing-container">
            <div class="premium-cta">
                <p>
                    <?php echo sprintf( __('Upgrade to %1$spremium version%2$s of %1$sYITH WooCommerce Recover Abandoned Cart%2$s to benefit from all features!','yith-woocommerce-recover-abandoned-cart'),'<span class="highlight">','</span>' );?>
                </p>
                <a href="<?php echo $this->get_premium_landing_uri() ?>" target="_blank" class="premium-cta-button button btn">
                    <span class="highlight"><?php _e('UPGRADE','yith-woocommerce-recover-abandoned-cart');?></span>
                    <span><?php _e('to the premium version','yith-woocommerce-recover-abandoned-cart');?></span>
                </a>
            </div>
        </div>
    </div>
    <div class="one section section-even clear">
        <h1><?php _e('Premium Features','yith-woocommerce-recover-abandoned-cart');?></h1>
        <div class="landing-container">
            <div class="col-1">
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Guest users','yith-woocommerce-recover-abandoned-cart');?></h2>
                </div>
                <p>
                    <?php echo sprintf(__('It happens many times that an %1$sunregistered%2$s user was so near to purchase, had filled our %1$scheckout%2$s form but then had not completed the order for connection problems or for doubts aroused at the last minute.%3$sWith the premium version of the plugin, you will be able to track also these users and contact them in a later moment to remind them of complete their missed purchase.', 'yith-woocommerce-recover-abandoned-cart'), '<b>', '</b>','<br>');?>
                </p>
            </div>
            <div class="col-1">
        ...
        <div class="landing-container">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e( 'Notification email','yith-woocommerce-recover-abandoned-cart');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __('What\'s more satisfying than seeing an abandoned cart turning into a purchase order? %1$sYou can get emails for each successful conversion%2$s, containing all information about the order and the user who made it. Keep always updated about what happens in your e-commerce shop.', 'yith-woocommerce-recover-abandoned-cart'),'<b>','</b>');?>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Different email templates ','yith-woocommerce-recover-abandoned-cart');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __('Endless email templates that you can configure to encourage reluctant users to %1$scome back to your shop%2$s and evaluate the purchase offer.%3$sWrite emails and schedule their sending, proposing new contents and always more interesting offers. Do not let it go is the first rule to aim to success!', 'yith-woocommerce-recover-abandoned-cart'),'<b>','</b>','<br>');?>
                </p>
            </div>
            <div class="col-1">
        ...
        <div class="landing-container">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Coupons','yith-woocommerce-recover-abandoned-cart');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __('The most seducing weapon to approach users that have already visited your shop. A different coupon for each email template: you can configure %1$sdiscounts%2$s and %1$sexpiration date%2$s, in order to urge your users to hurry and reduce the possible useless doubts they can have.','yith-woocommerce-recover-abandoned-cart'),'<b>','</b>'); ?>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Log','yith-woocommerce-recover-abandoned-cart');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __( 'A complete list of the traced emails of your %1$sshop%2$s to have an order history of all users that have thought to purchase on your shop.%3$sThanks to the general page, you will be able to see at a glance the complete list of all generated %1$semails%2$s from the plugin and their related information, just like the IDs of the abandoned carts and the date in which they were sent.','yith-woocommerce-recover-abandoned-cart' ),'<b>','</b>','<br>' ) ?>
                </p>
            </div>
            <div class="col-1">
        ...
        <div class="landing-container">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Advanced report','yith-woocommerce-recover-abandoned-cart');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __('Read the information of the plugin report, so that you can easily go back to the recap data of your site. The overall amount of %1$sabandoned carts%2$s and those recovered, the %1$sconversion rate%2$s of the carts, and the total %1$searnings%2$s that they had on the economy of your shop.And for statistics lovers, the amount of emails sent, and how many visits these have generated.%3$sEverything to make your e-commerce better.','yith-woocommerce-recover-abandoned-cart'),'<b>','</b>','<br>'); ?>
                </p>
            </div>
        </div>
    </div>
