...
if ( !class_exists( 'YITH_YWRAC_Send_Email' ) ) {
    ...
    class YITH_YWRAC_Send_Email extends WC_Email {
        ...
        public function __construct() {
            ...
            $this->description = __( 'This is the email sent to the customer from the admin in YITH WooCommerce Recover Abandoned Cart Plugin', 'yith-woocommerce-recover-abandoned-cart' );
