    ...
    class YITH_WC_Recover_Abandoned_Cart_Admin {
        ...
        public function enqueue_styles_scripts() {
            ...
            wp_localize_script( 'yith_ywrac_admin', 'yith_ywrac_admin', array(
                ...
                'sent_label'       => __('Email Sent', 'yith-woocommerce-recover-abandoned-cart'),
        ...
        public function register_panel() {
            ...
            $admin_tabs = array(
                ...
                'email'   => __( 'Email Template', 'yith-woocommerce-recover-abandoned-cart' )
            );

            if ( defined( 'YITH_YWRAC_FREE_INIT' ) ) {
                $admin_tabs['premium'] = __( 'Premium Version', 'yith-woocommerce-recover-abandoned-cart' );
            }
