...
if ( defined( 'YITH_YWRAC_PREMIUM' ) ) {
    function yith_ywrac_install_free_admin_notice() {
        ?>
        <div class="error">
            <p><?php _e( 'You can\'t activate the free version of YITH WooCommerce Recover Abandoned Cart while you are using the premium one.', 'yith-woocommerce-recover-abandoned-cart' ); ?></p>
        </div>
    <?php
    }
...
if ( defined( 'YITH_YWRAC_VERSION' ) ) {
    ...
    define( 'YITH_YWRAC_VERSION', '1.1.1' );
}
